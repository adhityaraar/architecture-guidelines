...
const PAGES = [
  ...
  // LEGACY / DataStage
  { label:'DataStage and QualityStage Overview',file:'InfoSphere/DataStage/ds-overview.html',   tab:'tab-infosphere', tabLabel:'LEGACY', badgeColor:'#0f7b5e', badgeBg:'#e6f4ee', href:'InfoSphere/DataStage/ds-overview.html', keywords:'InfoSphere DataStage QualityStage introduction capabilities use cases terminology ETL data integration data quality standardize match trusted data' },
  { label:'DataStage Architecture',           file:'InfoSphere/DataStage/ds-topology.html',    tab:'tab-infosphere', tabLabel:'LEGACY', badgeColor:'#0f7b5e', badgeBg:'#e6f4ee', href:'InfoSphere/DataStage/ds-topology.html', keywords:'DataStage architecture metadata business technical operational internal external design reporting lifecycle xmeta shared repository staging lineage impact analysis client services repository engine data flow topology HA DR' },
  { label:'DataStage Topology and Engine Patterns',file:'InfoSphere/DataStage/ds-engine.html', tab:'tab-infosphere', tabLabel:'LEGACY', badgeColor:'#0f7b5e', badgeBg:'#e6f4ee', href:'InfoSphere/DataStage/ds-engine.html', keywords:'single computer client server dedicated tier engine MPP grid multiple engines web services conductor section leader player parallelism configuration file scratch dataset' },
  { label:'DataStage HA / DR Architecture',   file:'InfoSphere/DataStage/ds-repo.html',        tab:'tab-infosphere', tabLabel:'LEGACY', badgeColor:'#0f7b5e', badgeBg:'#e6f4ee', href:'InfoSphere/DataStage/ds-repo.html', keywords:'DataStage HADR active-active services WebSphere cluster active-passive engine shared filesystem synchronization virtual hostname fencing repository Db2 HADR log shipping replay takeover disaster recovery DR replication consistency' },
  { label:'DataStage Operations',             file:'InfoSphere/DataStage/ds-monitoring.html',  tab:'tab-infosphere', tabLabel:'LEGACY', badgeColor:'#0f7b5e', badgeBg:'#e6f4ee', href:'InfoSphere/DataStage/ds-monitoring.html', keywords:'day to day monitoring performance maintenance diagnostics operational metadata tools commands dsjob istool evidence' },
  { label:'DataStage Backup and HA / DR Operations',file:'InfoSphere/DataStage/ds-recovery.html',tab:'tab-infosphere', tabLabel:'LEGACY', badgeColor:'#0f7b5e', badgeBg:'#e6f4ee', href:'InfoSphere/DataStage/ds-recovery.html', keywords:'backup recovery synchronization active active active passive Db2 HADR takeover failover disaster recovery storage replication level 0 restore' },
  { label:'DataStage Deployment and Lifecycle',file:'InfoSphere/DataStage/ds-checklist.html',  tab:'tab-infosphere', tabLabel:'LEGACY', badgeColor:'#0f7b5e', badgeBg:'#e6f4ee', href:'InfoSphere/DataStage/ds-checklist.html', keywords:'requirements specifications sizing installation configuration upgrade migration modernization source control istool deployment package DEV TEST PROD SIMPLE UNIFIED REPORTING GOVERNANCE Redbook scenarios' },
  ...
  { label:'DataStage FAQ and Quick Reference',file:'InfoSphere/DataStage/ds-faq.html',         tab:'tab-infosphere', tabLabel:'LEGACY', badgeColor:'#0f7b5e', badgeBg:'#e6f4ee', href:'InfoSphere/DataStage/ds-faq.html', keywords:'logs diagnostics common issues RCA best practices quick reference Redbook coverage' },
  // LEGACY / CDC
